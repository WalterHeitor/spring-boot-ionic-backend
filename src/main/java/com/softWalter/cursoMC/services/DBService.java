...
public class DBService {
	...
	public void instantiateTestDatebase() throws ParseException {
		...
		Categoria cat5 = new Categoria(null, "Mecanica");
		Categoria cat6 = new Categoria(null, "Solda");
		Categoria cat7 = new Categoria(null, "Montagens");
		...
		Produto p7 = new Produto(null, "TV 50 pol sansung", 2680.00);
		Produto p8 = new Produto(null, "Roçadeira", 780.00);
		Produto p9 = new Produto(null, "Abajur", 70.00);
		Produto p10 = new Produto(null, "Pendente", 35.00);
		Produto p11 = new Produto(null, "Shampo", 20.00);
